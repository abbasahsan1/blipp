...
/**
 * Owns the persistent player UI: a mini player docked above the bottom tabs and
 * the expandable full-screen view. Mounted once inside the tabs layout so
 * playback survives tab changes.
 */
export function PlayerHost() {
  ...
  const currentIndex = queueIds.indexOf(post.id);
